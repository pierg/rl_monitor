...
class Results:
	...
	obs_values_names = ["trackPos", "speedX", "damage"] # The data who want to retrieve from the observations
	action_values_names = ["steering", "accel", "brake"] # The data who want to retrieve from the actions (in the proper order !)
