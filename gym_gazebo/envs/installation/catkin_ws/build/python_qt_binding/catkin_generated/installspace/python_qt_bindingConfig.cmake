...
if("FALSE" STREQUAL "TRUE")
  set(python_qt_binding_SOURCE_PREFIX /home/mxb/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/python_qt_binding)
  set(python_qt_binding_DEVEL_PREFIX /home/mxb/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel)
  ...
  set(python_qt_binding_INSTALL_PREFIX /home/mxb/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'python_qt_binding' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'python_qt_binding' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mxb/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/install/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${python_qt_binding_dep}_FOUND)
      find_package(${python_qt_binding_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${python_qt_binding_dep} REQUIRED ${depend_list})
  endif()
