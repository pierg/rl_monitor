...
if("FALSE" STREQUAL "TRUE")
  set(kobuki_rviz_launchers_SOURCE_PREFIX /home/mxb/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/kobuki_desktop/kobuki_rviz_launchers)
  set(kobuki_rviz_launchers_DEVEL_PREFIX /home/mxb/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel)
  ...
  set(kobuki_rviz_launchers_INSTALL_PREFIX /home/mxb/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kobuki_rviz_launchers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kobuki_rviz_launchers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mxb/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/install/${idir}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${kobuki_rviz_launchers_dep}_FOUND)
      find_package(${kobuki_rviz_launchers_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${kobuki_rviz_launchers_dep} REQUIRED ${depend_list})
  endif()
