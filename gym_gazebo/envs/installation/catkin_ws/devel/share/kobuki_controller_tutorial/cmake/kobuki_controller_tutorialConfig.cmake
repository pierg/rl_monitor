...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_controller_tutorial_SOURCE_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/kobuki/kobuki_controller_tutorial)
  set(kobuki_controller_tutorial_DEVEL_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel)
  ...
  set(kobuki_controller_tutorial_INSTALL_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/install)
...
if(NOT "/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/kobuki/kobuki_controller_tutorial/include " STREQUAL " ")
  set(kobuki_controller_tutorial_INCLUDE_DIRS "")
  set(_include_dirs "/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/kobuki/kobuki_controller_tutorial/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kobuki_controller_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kobuki_controller_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/kobuki/kobuki_controller_tutorial/${idir}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${kobuki_controller_tutorial_dep}_FOUND)
      find_package(${kobuki_controller_tutorial_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${kobuki_controller_tutorial_dep} REQUIRED ${depend_list})
  endif()
