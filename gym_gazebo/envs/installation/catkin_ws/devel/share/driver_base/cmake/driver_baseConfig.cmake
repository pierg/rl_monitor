...
if("TRUE" STREQUAL "TRUE")
  set(driver_base_SOURCE_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/driver_base/driver_base)
  set(driver_base_DEVEL_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel)
  ...
  set(driver_base_INSTALL_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/install)
...
if(NOT "/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel/include;/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/driver_base/driver_base/include;/usr/include " STREQUAL " ")
  set(driver_base_INCLUDE_DIRS "")
  set(_include_dirs "/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel/include;/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/driver_base/driver_base/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/driver_base/driver_base/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
    endif()
...
set(driver_base_EXPORTED_TARGETS "driver_base_generate_messages_cpp;driver_base_generate_messages_lisp;driver_base_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${driver_base_dep}_FOUND)
      find_package(${driver_base_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${driver_base_dep} REQUIRED ${depend_list})
  endif()
