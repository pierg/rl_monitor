...
(cl:defclass <HandleSensors> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (responseHistory
    :reader responseHistory
    :initarg :responseHistory
...
(cl:defmethod responses-val ((m <HandleSensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handle_msgs-msg:responses-val is deprecated.  Use handle_msgs-msg:responses instead.")
  (responses m))

(cl:ensure-generic-function 'responseHistory-val :lambda-list '(m))
(cl:defmethod responseHistory-val ((m <HandleSensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handle_msgs-msg:responseHistory-val is deprecated.  Use handle_msgs-msg:responseHistory instead.")
  (responseHistory m))

(cl:ensure-generic-function 'motorError-val :lambda-list '(m))
(cl:defmethod motorError-val ((m <HandleSensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handle_msgs-msg:motorError-val is deprecated.  Use handle_msgs-msg:motorError instead.")
  (motorError m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <HandleSensors>) ostream)
  ...
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let* ((signed ele) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
   ...
   (cl:slot-value msg 'responseHistory))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let* ((signed ele) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 65536) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    ))
   (cl:slot-value msg 'motorError))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HandleSensors>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'distalAcceleration)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'geometry_msgs-msg:Vector3))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream)))
  (cl:setf (cl:slot-value msg 'responses) (cl:make-array 12))
  (cl:let ((vals (cl:slot-value msg 'responses)))
    (cl:dotimes (i 12)
    (cl:setf (cl:aref vals i) (cl:not (cl:zerop (cl:read-byte istream))))))
  (cl:setf (cl:slot-value msg 'responseHistory) (cl:make-array 12))
  (cl:let ((vals (cl:slot-value msg 'responseHistory)))
    (cl:dotimes (i 12)
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:aref vals i) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))))
  (cl:setf (cl:slot-value msg 'motorError) (cl:make-array 5))
  (cl:let ((vals (cl:slot-value msg 'motorError)))
    (cl:dotimes (i 5)
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HandleSensors>)))
  ...
  "41aa19d900cfb7233222088d703520cf")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HandleSensors)))
  "Returns md5sum for a message object of type 'HandleSensors"
  "41aa19d900cfb7233222088d703520cf")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <HandleSensors>))
  (cl:+ 0
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'responses) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 1)))
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'responseHistory) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 1)))
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'motorError) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 2)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <HandleSensors>))
  ...
  (cl:list 'HandleSensors
    ...
    (cl:cons ':responseHistory (responseHistory msg))
    (cl:cons ':motorError (motorError msg))
))
