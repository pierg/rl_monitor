...
if("TRUE" STREQUAL "TRUE")
  set(ecl_threads_SOURCE_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/ecl_core/ecl_threads)
  set(ecl_threads_DEVEL_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel)
  ...
  set(ecl_threads_INSTALL_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/install)
...
if(NOT "/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/ecl_core/ecl_threads/include " STREQUAL " ")
  set(ecl_threads_INCLUDE_DIRS "")
  set(_include_dirs "/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/ecl_core/ecl_threads/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ecl_threads' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ecl_threads' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/ecl_core/ecl_threads/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
