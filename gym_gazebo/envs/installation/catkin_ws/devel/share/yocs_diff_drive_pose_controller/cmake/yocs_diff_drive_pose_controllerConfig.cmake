...
if("TRUE" STREQUAL "TRUE")
  set(yocs_diff_drive_pose_controller_SOURCE_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/yujin_ocs/yocs_diff_drive_pose_controller)
  set(yocs_diff_drive_pose_controller_DEVEL_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel)
  ...
  set(yocs_diff_drive_pose_controller_INSTALL_PREFIX /home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/install)
...
if(NOT "/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/yujin_ocs/yocs_diff_drive_pose_controller/include " STREQUAL " ")
  set(yocs_diff_drive_pose_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/yujin_ocs/yocs_diff_drive_pose_controller/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'yocs_diff_drive_pose_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'yocs_diff_drive_pose_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/yujin_ocs/yocs_diff_drive_pose_controller/${idir}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
    endif()
    _list_append_unique(yocs_diff_drive_pose_controller_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "yocs_diff_drive_pose_controller_nodelet")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${yocs_diff_drive_pose_controller_dep}_FOUND)
      find_package(${yocs_diff_drive_pose_controller_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${yocs_diff_drive_pose_controller_dep} REQUIRED ${depend_list})
  endif()
