// Generated by gencpp from file atlas_msgs/SModelRobotOutput.msg
// DO NOT EDIT!


#ifndef ATLAS_MSGS_MESSAGE_SMODELROBOTOUTPUT_H
#define ATLAS_MSGS_MESSAGE_SMODELROBOTOUTPUT_H
...
struct SModelRobotOutput_
{
  ...
  typedef boost::shared_ptr< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> const> ConstPtr;

}; // struct SModelRobotOutput_

typedef ::atlas_msgs::SModelRobotOutput_<std::allocator<void> > SModelRobotOutput;

typedef boost::shared_ptr< ::atlas_msgs::SModelRobotOutput > SModelRobotOutputPtr;
typedef boost::shared_ptr< ::atlas_msgs::SModelRobotOutput const> SModelRobotOutputConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> >
{
  ...
  static const char* value(const ::atlas_msgs::SModelRobotOutput_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd0c643ca7dd9fdb2ULL;
  static const uint64_t static_value2 = 0xd935922bf6659387ULL;
};

template<class ContainerAllocator>
struct DataType< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> >
{
  static const char* value()
  {
    return "atlas_msgs/SModelRobotOutput";
  }
...
template<class ContainerAllocator>
struct Definition< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::atlas_msgs::SModelRobotOutput_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::atlas_msgs::SModelRobotOutput_<ContainerAllocator>& v)
  {
    s << indent << "rACT: ";
...
#endif // ATLAS_MSGS_MESSAGE_SMODELROBOTOUTPUT_H
