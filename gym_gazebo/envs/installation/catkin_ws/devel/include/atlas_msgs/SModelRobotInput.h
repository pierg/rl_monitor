// Generated by gencpp from file atlas_msgs/SModelRobotInput.msg
// DO NOT EDIT!


#ifndef ATLAS_MSGS_MESSAGE_SMODELROBOTINPUT_H
#define ATLAS_MSGS_MESSAGE_SMODELROBOTINPUT_H
...
struct SModelRobotInput_
{
  ...
  typedef boost::shared_ptr< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> const> ConstPtr;

}; // struct SModelRobotInput_

typedef ::atlas_msgs::SModelRobotInput_<std::allocator<void> > SModelRobotInput;

typedef boost::shared_ptr< ::atlas_msgs::SModelRobotInput > SModelRobotInputPtr;
typedef boost::shared_ptr< ::atlas_msgs::SModelRobotInput const> SModelRobotInputConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::atlas_msgs::SModelRobotInput_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> >
{
  ...
  static const char* value(const ::atlas_msgs::SModelRobotInput_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4d0701156e580a42ULL;
  static const uint64_t static_value2 = 0x0c48833f57bc83f3ULL;
};

template<class ContainerAllocator>
struct DataType< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> >
{
  static const char* value()
  {
    return "atlas_msgs/SModelRobotInput";
  }
...
template<class ContainerAllocator>
struct Definition< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::atlas_msgs::SModelRobotInput_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::atlas_msgs::SModelRobotInput_<ContainerAllocator>& v)
  {
    s << indent << "gACT: ";
...
#endif // ATLAS_MSGS_MESSAGE_SMODELROBOTINPUT_H
