// Generated by gencpp from file atlas_msgs/WalkDemoFeedback.msg
// DO NOT EDIT!


#ifndef ATLAS_MSGS_MESSAGE_WALKDEMOFEEDBACK_H
#define ATLAS_MSGS_MESSAGE_WALKDEMOFEEDBACK_H
...
struct WalkDemoFeedback_
{
  typedef WalkDemoFeedback_<ContainerAllocator> Type;

  WalkDemoFeedback_()
    : state()  {
    }
  WalkDemoFeedback_(const ContainerAllocator& _alloc)
    : state(_alloc)  {
  (void)_alloc;
    }
   ...
   typedef  ::atlas_msgs::AtlasSimInterfaceState_<ContainerAllocator>  _state_type;
  _state_type state;




  typedef boost::shared_ptr< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> const> ConstPtr;

}; // struct WalkDemoFeedback_

typedef ::atlas_msgs::WalkDemoFeedback_<std::allocator<void> > WalkDemoFeedback;

typedef boost::shared_ptr< ::atlas_msgs::WalkDemoFeedback > WalkDemoFeedbackPtr;
typedef boost::shared_ptr< ::atlas_msgs::WalkDemoFeedback const> WalkDemoFeedbackConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> >
{
  static const char* value()
  {
    return "7359756382c73b4c8a344edabb84e72e";
  }

  static const char* value(const ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7359756382c73b4cULL;
  static const uint64_t static_value2 = 0x8a344edabb84e72eULL;
};

template<class ContainerAllocator>
struct DataType< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> >
{
  static const char* value()
  {
    return "atlas_msgs/WalkDemoFeedback";
  }
...
template<class ContainerAllocator>
struct Definition< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::atlas_msgs::WalkDemoFeedback_<ContainerAllocator>& v)
  {
    s << indent << "state: ";
    s << std::endl;
    Printer< ::atlas_msgs::AtlasSimInterfaceState_<ContainerAllocator> >::stream(s, indent + "  ", v.state);
  }
};
...
#endif // ATLAS_MSGS_MESSAGE_WALKDEMOFEEDBACK_H
