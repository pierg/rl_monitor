// Generated by gencpp from file atlas_msgs/WalkDemoAction.msg
// DO NOT EDIT!


#ifndef ATLAS_MSGS_MESSAGE_WALKDEMOACTION_H
#define ATLAS_MSGS_MESSAGE_WALKDEMOACTION_H
...
#include <atlas_msgs/WalkDemoActionGoal.h>
#include <atlas_msgs/WalkDemoActionResult.h>
#include <atlas_msgs/WalkDemoActionFeedback.h>

namespace atlas_msgs
{
template <class ContainerAllocator>
struct WalkDemoAction_
{
  typedef WalkDemoAction_<ContainerAllocator> Type;
  ...
  WalkDemoAction_(const ContainerAllocator& _alloc)
    : action_goal(_alloc)
  ...
  (void)_alloc;
   ...
   typedef  ::atlas_msgs::WalkDemoActionGoal_<ContainerAllocator>  _action_goal_type;
  _action_goal_type action_goal;

   typedef  ::atlas_msgs::WalkDemoActionResult_<ContainerAllocator>  _action_result_type;
  _action_result_type action_result;

   typedef  ::atlas_msgs::WalkDemoActionFeedback_<ContainerAllocator>  _action_feedback_type;
  _action_feedback_type action_feedback;




  typedef boost::shared_ptr< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> const> ConstPtr;

}; // struct WalkDemoAction_

typedef ::atlas_msgs::WalkDemoAction_<std::allocator<void> > WalkDemoAction;

typedef boost::shared_ptr< ::atlas_msgs::WalkDemoAction > WalkDemoActionPtr;
typedef boost::shared_ptr< ::atlas_msgs::WalkDemoAction const> WalkDemoActionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::atlas_msgs::WalkDemoAction_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dec6d13e3463f3ef3113d4087856cd23";
  }

  static const char* value(const ::atlas_msgs::WalkDemoAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xdec6d13e3463f3efULL;
  static const uint64_t static_value2 = 0x3113d4087856cd23ULL;
};

template<class ContainerAllocator>
struct DataType< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> >
{
  static const char* value()
  {
    return "atlas_msgs/WalkDemoAction";
  }
...
template<class ContainerAllocator>
struct Definition< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::atlas_msgs::WalkDemoAction_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::atlas_msgs::WalkDemoAction_<ContainerAllocator>& v)
  {
    s << indent << "action_goal: ";
    s << std::endl;
    Printer< ::atlas_msgs::WalkDemoActionGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.action_goal);
    s << indent << "action_result: ";
    s << std::endl;
    Printer< ::atlas_msgs::WalkDemoActionResult_<ContainerAllocator> >::stream(s, indent + "  ", v.action_result);
    s << indent << "action_feedback: ";
    s << std::endl;
    Printer< ::atlas_msgs::WalkDemoActionFeedback_<ContainerAllocator> >::stream(s, indent + "  ", v.action_feedback);
  }
};
...
#endif // ATLAS_MSGS_MESSAGE_WALKDEMOACTION_H
