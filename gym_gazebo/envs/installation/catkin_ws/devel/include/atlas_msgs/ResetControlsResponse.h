// Generated by gencpp from file atlas_msgs/ResetControlsResponse.msg
// DO NOT EDIT!


#ifndef ATLAS_MSGS_MESSAGE_RESETCONTROLSRESPONSE_H
#define ATLAS_MSGS_MESSAGE_RESETCONTROLSRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::atlas_msgs::ResetControlsResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::atlas_msgs::ResetControlsResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::atlas_msgs::ResetControlsResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::atlas_msgs::ResetControlsResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atlas_msgs::ResetControlsResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::atlas_msgs::ResetControlsResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atlas_msgs::ResetControlsResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::atlas_msgs::ResetControlsResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::atlas_msgs::ResetControlsResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::atlas_msgs::ResetControlsResponse_<ContainerAllocator>& v)
  {
    s << indent << "success: ";
...
#endif // ATLAS_MSGS_MESSAGE_RESETCONTROLSRESPONSE_H
