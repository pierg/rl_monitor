// Generated by gencpp from file sandia_hand_msgs/SimpleGraspSrvResponse.msg
// DO NOT EDIT!


#ifndef SANDIA_HAND_MSGS_MESSAGE_SIMPLEGRASPSRVRESPONSE_H
#define SANDIA_HAND_MSGS_MESSAGE_SIMPLEGRASPSRVRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::sandia_hand_msgs::SimpleGraspSrvResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sandia_hand_msgs::SimpleGraspSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sandia_hand_msgs::SimpleGraspSrvResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sandia_hand_msgs::SimpleGraspSrvResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sandia_hand_msgs::SimpleGraspSrvResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sandia_hand_msgs::SimpleGraspSrvResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sandia_hand_msgs::SimpleGraspSrvResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sandia_hand_msgs::SimpleGraspSrvResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::sandia_hand_msgs::SimpleGraspSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::sandia_hand_msgs::SimpleGraspSrvResponse_<ContainerAllocator>&)
  {}
};
...
#endif // SANDIA_HAND_MSGS_MESSAGE_SIMPLEGRASPSRVRESPONSE_H
