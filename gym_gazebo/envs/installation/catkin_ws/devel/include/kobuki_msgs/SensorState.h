...
struct SensorState_
{
  ...
  _analog_input_type analog_input;
    ...
    enum { BUMPER_RIGHT = 1u };
     enum { BUMPER_CENTRE = 2u };
     enum { BUMPER_LEFT = 4u };
     enum { WHEEL_DROP_RIGHT = 1u };
     enum { WHEEL_DROP_LEFT = 2u };
     enum { CLIFF_RIGHT = 1u };
     enum { CLIFF_CENTRE = 2u };
     enum { CLIFF_LEFT = 4u };
     enum { BUTTON0 = 1u };
     enum { BUTTON1 = 2u };
     enum { BUTTON2 = 4u };
     enum { DISCHARGING = 0u };
     enum { DOCKING_CHARGED = 2u };
     enum { DOCKING_CHARGING = 6u };
     enum { ADAPTER_CHARGED = 18u };
     enum { ADAPTER_CHARGING = 22u };
     enum { OVER_CURRENT_LEFT_WHEEL = 1u };
     enum { OVER_CURRENT_RIGHT_WHEEL = 2u };
     enum { OVER_CURRENT_BOTH_WHEELS = 3u };
     enum { DIGITAL_INPUT0 = 1u };
     enum { DIGITAL_INPUT1 = 2u };
     enum { DIGITAL_INPUT2 = 4u };
     enum { DIGITAL_INPUT3 = 8u };
     enum { DB25_TEST_BOARD_CONNECTED = 64u };
...
// {'kobuki_msgs': ['/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/kobuki_msgs/msg', '/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel/share/kobuki_msgs/msg'], 'actionlib_msgs': ['/opt/ros/indigo/share/actionlib_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg']}
