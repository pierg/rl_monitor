...
struct RawTurtlebotSensorState_
{
  ...
  _requested_left_velocity_type requested_left_velocity;
    ...
    enum { OI_MODE_OFF = 0u };
     enum { OI_MODE_PASSIVE = 1u };
     enum { OI_MODE_SAFE = 2u };
     enum { OI_MODE_FULL = 3u };
     enum { REMOTE_LEFT = 129u };
     enum { REMOTE_FORWARD = 130u };
     enum { REMOTE_RIGHT = 131u };
     enum { REMOTE_SPOT = 132u };
     enum { REMOTE_MAX = 133u };
     enum { REMOTE_SMALL = 134u };
     enum { REMOTE_MEDIUM = 135u };
     enum { REMOTE_LARGE = 136u };
     enum { REMOTE_CLEAN = 136u };
     enum { REMOTE_PAUSE = 137u };
     enum { REMOTE_POWER = 138u };
     enum { REMOTE_ARC_LEFT = 139u };
     enum { REMOTE_ARC_RIGHT = 140u };
     enum { REMOTE_DRIVE_STOP = 141u };
     enum { REMOTE_SEND_ALL = 142u };
     enum { REMOTE_SEEK_DOCK = 143u };
     enum { REMOTE_RESERVED = 240u };
     enum { REMOTE_FORCE_FIELD = 242u };
     enum { REMOTE_GREEN_BUOY = 244u };
     enum { REMOTE_GREEN_BUOY_AND_FORCE_FIELD = 246u };
     enum { REMOTE_RED_BUOY = 248u };
     enum { REMOTE_RED_BUOY_AND_FORCE_FIELD = 250u };
     enum { REMOTE_RED_BUOY_AND_GREEN_BUOY = 252u };
     enum { REMOTE_RED_BUOY_AND_GREEN_BUOY_AND_FORCE_FIELD = 254u };
     enum { REMOTE_NONE = 255u };
     enum { CHARGING_NOT_CHARGING = 0u };
     enum { CHARGING_CHARGING_RECOVERY = 1u };
     enum { CHARGING_CHARGING = 2u };
     enum { CHARGING_TRICKLE_CHARGING = 3u };
     enum { CHARGING_WAITING = 4u };
     enum { CHARGING_CHARGING_ERROR = 5u };
...
// {'nav_msgs': ['/opt/ros/indigo/share/nav_msgs/cmake/../msg'], 'actionlib_msgs': ['/opt/ros/indigo/share/actionlib_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/indigo/share/geometry_msgs/cmake/../msg'], 'create_node': ['/home/chalmers/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/turtlebot_create/create_node/msg'], 'diagnostic_msgs': ['/opt/ros/indigo/share/diagnostic_msgs/cmake/../msg']}
