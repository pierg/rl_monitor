...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6d.pack(_x.angular_velocity_zeroed.x, _x.angular_velocity_zeroed.y, _x.angular_velocity_zeroed.z, _x.angular_velocity_raw.x, _x.angular_velocity_raw.y, _x.angular_velocity_raw.z))
      buff.write(_struct_9d.pack(*self.angular_velocity_covariance))
      _x = self
      buff.write(_struct_6d.pack(_x.linear_acceleration_zeroed.x, _x.linear_acceleration_zeroed.y, _x.linear_acceleration_zeroed.z, _x.linear_acceleration_raw.x, _x.linear_acceleration_raw.y, _x.linear_acceleration_raw.z))
      buff.write(_struct_9d.pack(*self.linear_acceleration_covariance))
      _x = self
      buff.write(_struct_6d.pack(_x.nunchuk_acceleration_zeroed.x, _x.nunchuk_acceleration_zeroed.y, _x.nunchuk_acceleration_zeroed.z, _x.nunchuk_acceleration_raw.x, _x.nunchuk_acceleration_raw.y, _x.nunchuk_acceleration_raw.z))
      buff.write(_struct_2f.pack(*self.nunchuk_joystick_zeroed))
      buff.write(_struct_2f.pack(*self.nunchuk_joystick_raw))
      buff.write(_struct_11B.pack(*self.buttons))
      buff.write(_struct_2B.pack(*self.nunchuk_buttons))
      buff.write(_struct_4B.pack(*self.LEDs))
      buff.write(_struct_B.pack(self.rumble))
      ...
      _x = self
      buff.write(_struct_2f2IQ.pack(_x.raw_battery, _x.percent_battery, _x.zeroing_time.secs, _x.zeroing_time.nsecs, _x.errors))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.angular_velocity_zeroed.x, _x.angular_velocity_zeroed.y, _x.angular_velocity_zeroed.z, _x.angular_velocity_raw.x, _x.angular_velocity_raw.y, _x.angular_velocity_raw.z,) = _struct_6d.unpack(str[start:end])
      start = end
      end += 72
      ...
      (_x.linear_acceleration_zeroed.x, _x.linear_acceleration_zeroed.y, _x.linear_acceleration_zeroed.z, _x.linear_acceleration_raw.x, _x.linear_acceleration_raw.y, _x.linear_acceleration_raw.z,) = _struct_6d.unpack(str[start:end])
      start = end
      end += 72
      ...
      (_x.nunchuk_acceleration_zeroed.x, _x.nunchuk_acceleration_zeroed.y, _x.nunchuk_acceleration_zeroed.z, _x.nunchuk_acceleration_raw.x, _x.nunchuk_acceleration_raw.y, _x.nunchuk_acceleration_raw.z,) = _struct_6d.unpack(str[start:end])
      start = end
      end += 8
      self.nunchuk_joystick_zeroed = _struct_2f.unpack(str[start:end])
      start = end
      end += 8
      self.nunchuk_joystick_raw = _struct_2f.unpack(str[start:end])
      start = end
      end += 11
      self.buttons = _struct_11B.unpack(str[start:end])
      self.buttons = map(bool, self.buttons)
      start = end
      end += 2
      self.nunchuk_buttons = _struct_2B.unpack(str[start:end])
      self.nunchuk_buttons = map(bool, self.nunchuk_buttons)
      start = end
      end += 4
      self.LEDs = _struct_4B.unpack(str[start:end])
      self.LEDs = map(bool, self.LEDs)
      start = end
      end += 1
      (self.rumble,) = _struct_B.unpack(str[start:end])
      ...
      (_x.raw_battery, _x.percent_battery, _x.zeroing_time.secs, _x.zeroing_time.nsecs, _x.errors,) = _struct_2f2IQ.unpack(str[start:end])
