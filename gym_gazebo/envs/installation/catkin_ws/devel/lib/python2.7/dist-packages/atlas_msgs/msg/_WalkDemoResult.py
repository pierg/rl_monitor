...
"""autogenerated by genpy from atlas_msgs/WalkDemoResult.msg. Do not edit."""
import sys
...
class WalkDemoResult(genpy.Message):
  _md5sum = "4644a04e1284938b734d6fd11b5438d6"
  _type = "atlas_msgs/WalkDemoResult"
...
float64 com_v0
float64 com_v1"""
  __slots__ = ['end_state','success']
  _slot_types = ['atlas_msgs/AtlasSimInterfaceState','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WalkDemoResult, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.end_state is None:
        self.end_state = atlas_msgs.msg.AtlasSimInterfaceState()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3i.pack(_x.end_state.error_code, _x.end_state.current_behavior, _x.end_state.desired_behavior))
      buff.write(_struct_30d.pack(*self.end_state.f_out))
      _x = self
      buff.write(_struct_6d.pack(_x.end_state.pos_est.position.x, _x.end_state.pos_est.position.y, _x.end_state.pos_est.position.z, _x.end_state.pos_est.velocity.x, _x.end_state.pos_est.velocity.y, _x.end_state.pos_est.velocity.z))
      for val1 in self.end_state.foot_pos_est:
        _v1 = val1.position
        _x = _v1
      ...
      _x = self
      buff.write(_struct_I2iId4I9dId3I.pack(_x.end_state.behavior_feedback.status_flags, _x.end_state.behavior_feedback.trans_from_behavior_index, _x.end_state.behavior_feedback.trans_to_behavior_index, _x.end_state.step_feedback.status_flags, _x.end_state.step_feedback.t_step_rem, _x.end_state.step_feedback.current_step_index, _x.end_state.step_feedback.next_step_index_needed, _x.end_state.step_feedback.desired_step_saturated.step_index, _x.end_state.step_feedback.desired_step_saturated.foot_index, _x.end_state.step_feedback.desired_step_saturated.duration, _x.end_state.step_feedback.desired_step_saturated.pose.position.x, _x.end_state.step_feedback.desired_step_saturated.pose.position.y, _x.end_state.step_feedback.desired_step_saturated.pose.position.z, _x.end_state.step_feedback.desired_step_saturated.pose.orientation.x, _x.end_state.step_feedback.desired_step_saturated.pose.orientation.y, _x.end_state.step_feedback.desired_step_saturated.pose.orientation.z, _x.end_state.step_feedback.desired_step_saturated.pose.orientation.w, _x.end_state.step_feedback.desired_step_saturated.swing_height, _x.end_state.stand_feedback.status_flags, _x.end_state.walk_feedback.t_step_rem, _x.end_state.walk_feedback.current_step_index, _x.end_state.walk_feedback.next_step_index_needed, _x.end_state.walk_feedback.status_flags))
      for val1 in self.end_state.walk_feedback.step_queue_saturated:
        _x = val1
      ...
      _x = self
      buff.write(_struct_I7d.pack(_x.end_state.manipulate_feedback.status_flags, _x.end_state.manipulate_feedback.clamped.pelvis_height, _x.end_state.manipulate_feedback.clamped.pelvis_yaw, _x.end_state.manipulate_feedback.clamped.pelvis_lat, _x.end_state.manipulate_feedback.clamped.pelvis_pitch, _x.end_state.manipulate_feedback.clamped.pelvis_roll, _x.end_state.manipulate_feedback.clamped.com_v0, _x.end_state.manipulate_feedback.clamped.com_v1))
      _x = self.end_state.k_effort
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.end_state.error_code, _x.end_state.current_behavior, _x.end_state.desired_behavior,) = _struct_3i.unpack(str[start:end])
      start = end
      end += 240
      self.end_state.f_out = _struct_30d.unpack(str[start:end])
      _x = self
      start = end
      end += 48
      (_x.end_state.pos_est.position.x, _x.end_state.pos_est.position.y, _x.end_state.pos_est.position.z, _x.end_state.pos_est.velocity.x, _x.end_state.pos_est.velocity.y, _x.end_state.pos_est.velocity.z,) = _struct_6d.unpack(str[start:end])
      self.end_state.foot_pos_est = []
      for i in range(0, 2):
        ...
        self.end_state.foot_pos_est.append(val1)
      _x = self
      start = end
      end += 136
      (_x.end_state.behavior_feedback.status_flags, _x.end_state.behavior_feedback.trans_from_behavior_index, _x.end_state.behavior_feedback.trans_to_behavior_index, _x.end_state.step_feedback.status_flags, _x.end_state.step_feedback.t_step_rem, _x.end_state.step_feedback.current_step_index, _x.end_state.step_feedback.next_step_index_needed, _x.end_state.step_feedback.desired_step_saturated.step_index, _x.end_state.step_feedback.desired_step_saturated.foot_index, _x.end_state.step_feedback.desired_step_saturated.duration, _x.end_state.step_feedback.desired_step_saturated.pose.position.x, _x.end_state.step_feedback.desired_step_saturated.pose.position.y, _x.end_state.step_feedback.desired_step_saturated.pose.position.z, _x.end_state.step_feedback.desired_step_saturated.pose.orientation.x, _x.end_state.step_feedback.desired_step_saturated.pose.orientation.y, _x.end_state.step_feedback.desired_step_saturated.pose.orientation.z, _x.end_state.step_feedback.desired_step_saturated.pose.orientation.w, _x.end_state.step_feedback.desired_step_saturated.swing_height, _x.end_state.stand_feedback.status_flags, _x.end_state.walk_feedback.t_step_rem, _x.end_state.walk_feedback.current_step_index, _x.end_state.walk_feedback.next_step_index_needed, _x.end_state.walk_feedback.status_flags,) = _struct_I2iId4I9dId3I.unpack(str[start:end])
      self.end_state.walk_feedback.step_queue_saturated = []
      for i in range(0, 4):
        ...
        self.end_state.walk_feedback.step_queue_saturated.append(val1)
      _x = self
      start = end
      end += 60
      (_x.end_state.manipulate_feedback.status_flags, _x.end_state.manipulate_feedback.clamped.pelvis_height, _x.end_state.manipulate_feedback.clamped.pelvis_yaw, _x.end_state.manipulate_feedback.clamped.pelvis_lat, _x.end_state.manipulate_feedback.clamped.pelvis_pitch, _x.end_state.manipulate_feedback.clamped.pelvis_roll, _x.end_state.manipulate_feedback.clamped.com_v0, _x.end_state.manipulate_feedback.clamped.com_v1,) = _struct_I7d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.end_state.k_effort = str[start:end]
      start = end
      end += 1
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3i.pack(_x.end_state.error_code, _x.end_state.current_behavior, _x.end_state.desired_behavior))
      buff.write(self.end_state.f_out.tostring())
      _x = self
      buff.write(_struct_6d.pack(_x.end_state.pos_est.position.x, _x.end_state.pos_est.position.y, _x.end_state.pos_est.position.z, _x.end_state.pos_est.velocity.x, _x.end_state.pos_est.velocity.y, _x.end_state.pos_est.velocity.z))
      for val1 in self.end_state.foot_pos_est:
        _v11 = val1.position
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.end_state.f_out = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=30)
      _x = self
      start = end
      end += 48
      (_x.end_state.pos_est.position.x, _x.end_state.pos_est.position.y, _x.end_state.pos_est.position.z, _x.end_state.pos_est.velocity.x, _x.end_state.pos_est.velocity.y, _x.end_state.pos_est.velocity.z,) = _struct_6d.unpack(str[start:end])
