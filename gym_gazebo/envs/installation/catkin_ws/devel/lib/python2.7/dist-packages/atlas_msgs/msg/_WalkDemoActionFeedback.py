...
"""autogenerated by genpy from atlas_msgs/WalkDemoActionFeedback.msg. Do not edit."""
import sys
...
class WalkDemoActionFeedback(genpy.Message):
  _md5sum = "26ccc064746d01b3f987881142ccfe75"
  _type = "atlas_msgs/WalkDemoActionFeedback"
...
float64 com_v1"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','atlas_msgs/WalkDemoFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WalkDemoActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = atlas_msgs.msg.WalkDemoFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = atlas_msgs.msg.WalkDemoFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3i.pack(_x.feedback.state.error_code, _x.feedback.state.current_behavior, _x.feedback.state.desired_behavior))
      buff.write(_struct_30d.pack(*self.feedback.state.f_out))
      _x = self
      buff.write(_struct_6d.pack(_x.feedback.state.pos_est.position.x, _x.feedback.state.pos_est.position.y, _x.feedback.state.pos_est.position.z, _x.feedback.state.pos_est.velocity.x, _x.feedback.state.pos_est.velocity.y, _x.feedback.state.pos_est.velocity.z))
      for val1 in self.feedback.state.foot_pos_est:
        _v1 = val1.position
        _x = _v1
      ...
      _x = self
      buff.write(_struct_I2iId4I9dId3I.pack(_x.feedback.state.behavior_feedback.status_flags, _x.feedback.state.behavior_feedback.trans_from_behavior_index, _x.feedback.state.behavior_feedback.trans_to_behavior_index, _x.feedback.state.step_feedback.status_flags, _x.feedback.state.step_feedback.t_step_rem, _x.feedback.state.step_feedback.current_step_index, _x.feedback.state.step_feedback.next_step_index_needed, _x.feedback.state.step_feedback.desired_step_saturated.step_index, _x.feedback.state.step_feedback.desired_step_saturated.foot_index, _x.feedback.state.step_feedback.desired_step_saturated.duration, _x.feedback.state.step_feedback.desired_step_saturated.pose.position.x, _x.feedback.state.step_feedback.desired_step_saturated.pose.position.y, _x.feedback.state.step_feedback.desired_step_saturated.pose.position.z, _x.feedback.state.step_feedback.desired_step_saturated.pose.orientation.x, _x.feedback.state.step_feedback.desired_step_saturated.pose.orientation.y, _x.feedback.state.step_feedback.desired_step_saturated.pose.orientation.z, _x.feedback.state.step_feedback.desired_step_saturated.pose.orientation.w, _x.feedback.state.step_feedback.desired_step_saturated.swing_height, _x.feedback.state.stand_feedback.status_flags, _x.feedback.state.walk_feedback.t_step_rem, _x.feedback.state.walk_feedback.current_step_index, _x.feedback.state.walk_feedback.next_step_index_needed, _x.feedback.state.walk_feedback.status_flags))
      for val1 in self.feedback.state.walk_feedback.step_queue_saturated:
        _x = val1
      ...
      _x = self
      buff.write(_struct_I7d.pack(_x.feedback.state.manipulate_feedback.status_flags, _x.feedback.state.manipulate_feedback.clamped.pelvis_height, _x.feedback.state.manipulate_feedback.clamped.pelvis_yaw, _x.feedback.state.manipulate_feedback.clamped.pelvis_lat, _x.feedback.state.manipulate_feedback.clamped.pelvis_pitch, _x.feedback.state.manipulate_feedback.clamped.pelvis_roll, _x.feedback.state.manipulate_feedback.clamped.com_v0, _x.feedback.state.manipulate_feedback.clamped.com_v1))
      _x = self.feedback.state.k_effort
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.state.error_code, _x.feedback.state.current_behavior, _x.feedback.state.desired_behavior,) = _struct_3i.unpack(str[start:end])
      start = end
      end += 240
      self.feedback.state.f_out = _struct_30d.unpack(str[start:end])
      _x = self
      start = end
      end += 48
      (_x.feedback.state.pos_est.position.x, _x.feedback.state.pos_est.position.y, _x.feedback.state.pos_est.position.z, _x.feedback.state.pos_est.velocity.x, _x.feedback.state.pos_est.velocity.y, _x.feedback.state.pos_est.velocity.z,) = _struct_6d.unpack(str[start:end])
      self.feedback.state.foot_pos_est = []
      for i in range(0, 2):
        ...
        self.feedback.state.foot_pos_est.append(val1)
      _x = self
      start = end
      end += 136
      (_x.feedback.state.behavior_feedback.status_flags, _x.feedback.state.behavior_feedback.trans_from_behavior_index, _x.feedback.state.behavior_feedback.trans_to_behavior_index, _x.feedback.state.step_feedback.status_flags, _x.feedback.state.step_feedback.t_step_rem, _x.feedback.state.step_feedback.current_step_index, _x.feedback.state.step_feedback.next_step_index_needed, _x.feedback.state.step_feedback.desired_step_saturated.step_index, _x.feedback.state.step_feedback.desired_step_saturated.foot_index, _x.feedback.state.step_feedback.desired_step_saturated.duration, _x.feedback.state.step_feedback.desired_step_saturated.pose.position.x, _x.feedback.state.step_feedback.desired_step_saturated.pose.position.y, _x.feedback.state.step_feedback.desired_step_saturated.pose.position.z, _x.feedback.state.step_feedback.desired_step_saturated.pose.orientation.x, _x.feedback.state.step_feedback.desired_step_saturated.pose.orientation.y, _x.feedback.state.step_feedback.desired_step_saturated.pose.orientation.z, _x.feedback.state.step_feedback.desired_step_saturated.pose.orientation.w, _x.feedback.state.step_feedback.desired_step_saturated.swing_height, _x.feedback.state.stand_feedback.status_flags, _x.feedback.state.walk_feedback.t_step_rem, _x.feedback.state.walk_feedback.current_step_index, _x.feedback.state.walk_feedback.next_step_index_needed, _x.feedback.state.walk_feedback.status_flags,) = _struct_I2iId4I9dId3I.unpack(str[start:end])
      self.feedback.state.walk_feedback.step_queue_saturated = []
      for i in range(0, 4):
        ...
        self.feedback.state.walk_feedback.step_queue_saturated.append(val1)
      _x = self
      start = end
      end += 60
      (_x.feedback.state.manipulate_feedback.status_flags, _x.feedback.state.manipulate_feedback.clamped.pelvis_height, _x.feedback.state.manipulate_feedback.clamped.pelvis_yaw, _x.feedback.state.manipulate_feedback.clamped.pelvis_lat, _x.feedback.state.manipulate_feedback.clamped.pelvis_pitch, _x.feedback.state.manipulate_feedback.clamped.pelvis_roll, _x.feedback.state.manipulate_feedback.clamped.com_v0, _x.feedback.state.manipulate_feedback.clamped.com_v1,) = _struct_I7d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.feedback.state.k_effort = str[start:end]
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3i.pack(_x.feedback.state.error_code, _x.feedback.state.current_behavior, _x.feedback.state.desired_behavior))
      buff.write(self.feedback.state.f_out.tostring())
      _x = self
      buff.write(_struct_6d.pack(_x.feedback.state.pos_est.position.x, _x.feedback.state.pos_est.position.y, _x.feedback.state.pos_est.position.z, _x.feedback.state.pos_est.velocity.x, _x.feedback.state.pos_est.velocity.y, _x.feedback.state.pos_est.velocity.z))
      for val1 in self.feedback.state.foot_pos_est:
        _v11 = val1.position
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.feedback.state.f_out = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=30)
      _x = self
      start = end
      end += 48
      (_x.feedback.state.pos_est.position.x, _x.feedback.state.pos_est.position.y, _x.feedback.state.pos_est.position.z, _x.feedback.state.pos_est.velocity.x, _x.feedback.state.pos_est.velocity.y, _x.feedback.state.pos_est.velocity.z,) = _struct_6d.unpack(str[start:end])
