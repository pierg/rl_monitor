...
class TorcsEnv:
    ...
    def __init__(self, reward, vision=False, throttle=False, gear_change=False):
        ...
        if self.vision is True:
            os.system('torcs -nofuel -nodamage -nolaptime -vision -t 1000000000 &')
        else:
            os.system('torcs -nofuel -nolaptime -t 1000000000 &')
        time.sleep(0.5)
    ...
    def step(self, u, early_stop):
       #print("Step")
        ...
        return self.get_obs(), self.reward(obs, obs_pre, this_action ), client.R.d['meta'], obs==obs_pre, obs, {}
